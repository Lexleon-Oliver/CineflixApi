...
public class SerieMapperImpl implements SerieMapper{
    ...
    public Serie toSerieModel (SerieDTO serieDTO) {
        ...
        serie.setMinAge(serieDTO.getMinAge());
        serie.setTime(serieDTO.getTime());
        serie.setCompleted(serieDTO.isCompleted());
    ...
    public SerieDTO toSerieDTO(Serie serie) {
        ...
        serieDTO.setMinAge(serie.getMinAge());
        serieDTO.setTime(serie.getTime());
        serieDTO.setCompleted(serie.isCompleted());
    ...
    public Season toSeasonModel(SeasonDTO seasonDTO) {
        ...
        season.setSeasonBack(seasonDTO.getSeasonBack());
        return season;
    }
